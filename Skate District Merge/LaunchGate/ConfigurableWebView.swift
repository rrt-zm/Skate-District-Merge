...
/// A WKWebView wrapper that loads a start URL and, when gate-checking is enabled,
/// detects the blocked marker across navigation and reports readiness / failure.
